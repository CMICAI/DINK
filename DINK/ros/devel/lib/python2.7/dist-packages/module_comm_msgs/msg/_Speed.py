...
"""autogenerated by genpy from module_comm_msgs/Speed.msg. Do not edit."""
import sys
...
class Speed(genpy.Message):
  _md5sum = "19e5d1450bb352242868b04367a49847"
  _type = "module_comm_msgs/Speed"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Speed Control Message
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,module_name,speed,acceleration_limit,deceleration_limit
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3f().pack(_x.speed, _x.acceleration_limit, _x.deceleration_limit))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.speed, _x.acceleration_limit, _x.deceleration_limit,) = _get_struct_3f().unpack(str[start:end])
      return self
