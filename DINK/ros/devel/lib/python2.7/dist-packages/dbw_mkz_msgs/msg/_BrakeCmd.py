...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_f6B().pack(_x.pedal_cmd, _x.pedal_cmd_type, _x.boo_cmd, _x.enable, _x.clear, _x.ignore, _x.count))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pedal_cmd, _x.pedal_cmd_type, _x.boo_cmd, _x.enable, _x.clear, _x.ignore, _x.count,) = _get_struct_f6B().unpack(str[start:end])
