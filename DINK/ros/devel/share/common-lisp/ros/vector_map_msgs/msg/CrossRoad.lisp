...
(cl:defmethod cl:initialize-instance :after ((m <CrossRoad>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CrossRoad)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vector_map_msgs-msg:<CrossRoad> is deprecated: use vector_map_msgs-msg:CrossRoad instead.")))
