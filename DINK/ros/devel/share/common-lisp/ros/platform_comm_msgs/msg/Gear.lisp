...
(cl:defmethod cl:initialize-instance :after ((m <Gear>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gear)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name platform_comm_msgs-msg:<Gear> is deprecated: use platform_comm_msgs-msg:Gear instead.")))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <Gear>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader platform_comm_msgs-msg:gear-val is deprecated.  Use platform_comm_msgs-msg:gear instead.")
  (gear m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Gear>)))
  ...
  (cl:format cl:nil "# Transmission Gear Value~%# Provides common definitions for commanded and reported gear~%~%uint8 NONE=0~%uint8 PARK=1~%uint8 REVERSE=2~%uint8 NEUTRAL=3~%uint8 DRIVE=4~%uint8 LOW=5~%uint8 gear~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Gear)))
  "Returns full string definition for message of type 'Gear"
  (cl:format cl:nil "# Transmission Gear Value~%# Provides common definitions for commanded and reported gear~%~%uint8 NONE=0~%uint8 PARK=1~%uint8 REVERSE=2~%uint8 NEUTRAL=3~%uint8 DRIVE=4~%uint8 LOW=5~%uint8 gear~%~%~%~%"))
