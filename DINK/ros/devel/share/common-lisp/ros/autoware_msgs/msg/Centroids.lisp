...
(cl:defmethod cl:initialize-instance :after ((m <Centroids>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Centroids)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dink_for_msgs-msg:<Centroids> is deprecated: use dink_for_msgs-msg:Centroids instead.")))
...
(cl:defmethod points-val ((m <Centroids>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dink_for_msgs-msg:points-val is deprecated.  Use dink_for_msgs-msg:points instead.")
  (points m))
