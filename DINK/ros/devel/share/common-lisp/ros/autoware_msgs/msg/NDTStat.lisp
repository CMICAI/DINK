...
(cl:defmethod cl:initialize-instance :after ((m <NDTStat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NDTStat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dink_for_msgs-msg:<NDTStat> is deprecated: use dink_for_msgs-msg:NDTStat instead.")))
...
(cl:defmethod iteration-val ((m <NDTStat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dink_for_msgs-msg:iteration-val is deprecated.  Use dink_for_msgs-msg:iteration instead.")
  (iteration m))
