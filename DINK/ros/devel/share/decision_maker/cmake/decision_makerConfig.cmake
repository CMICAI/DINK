...
if("TRUE" STREQUAL "TRUE")
  set(decision_maker_SOURCE_PREFIX /home/dink/DINK/ros/src/computing/planning/decision/packages/decision_maker)
  set(decision_maker_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(decision_maker_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'decision_maker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/computing/planning/decision/packages/decision_maker/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;tf;std_msgs;dink_for_config_msgs;dink_for_msgs;geometry_msgs;vector_map_msgs;vector_map;jsk_recognition_msgs;vector_map_msgs;amathutils_lib;state_machine_lib")
