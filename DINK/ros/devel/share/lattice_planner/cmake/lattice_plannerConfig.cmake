...
if("TRUE" STREQUAL "TRUE")
  set(lattice_planner_SOURCE_PREFIX /home/dink/DINK/ros/src/computing/planning/motion/packages/lattice_planner)
  set(lattice_planner_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(lattice_planner_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT "/home/dink/DINK/ros/src/computing/planning/motion/packages/lattice_planner/include " STREQUAL " ")
  set(lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/dink/DINK/ros/src/computing/planning/motion/packages/lattice_planner/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/computing/planning/motion/packages/lattice_planner/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;std_msgs;pcl_ros;pcl_conversions;sensor_msgs;tf;gnss;waypoint_follower;vector_map;astar_planner;dink_for_can_msgs")
