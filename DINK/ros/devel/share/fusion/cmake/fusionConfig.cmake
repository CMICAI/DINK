...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /home/dink/DINK/ros/src/computing/perception/detection/lidar_tracker/libs/fusion)
  set(fusion_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  set(fusion_INSTALL_PREFIX "")
  set(fusion_PREFIX ${fusion_DEVEL_PREFIX})
else()
  set(fusion_SOURCE_PREFIX "")
  set(fusion_DEVEL_PREFIX "")
  set(fusion_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT "/home/dink/DINK/ros/src/computing/perception/detection/lidar_tracker/libs/fusion/include " STREQUAL " ")
  set(fusion_INCLUDE_DIRS "")
  set(_include_dirs "/home/dink/DINK/ros/src/computing/perception/detection/lidar_tracker/libs/fusion/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/computing/perception/detection/lidar_tracker/libs/fusion/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;dink_for_msgs;cv_bridge")
