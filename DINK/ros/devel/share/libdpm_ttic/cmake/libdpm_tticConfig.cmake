...
if("TRUE" STREQUAL "TRUE")
  set(libdpm_ttic_SOURCE_PREFIX /home/dink/DINK/ros/src/computing/perception/detection/vision_detector/libs/dpm_ttic)
  set(libdpm_ttic_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(libdpm_ttic_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT "/home/dink/DINK/ros/src/computing/perception/detection/vision_detector/libs/dpm_ttic/include " STREQUAL " ")
  set(libdpm_ttic_INCLUDE_DIRS "")
  set(_include_dirs "/home/dink/DINK/ros/src/computing/perception/detection/vision_detector/libs/dpm_ttic/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libdpm_ttic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/computing/perception/detection/vision_detector/libs/dpm_ttic/${idir}'.  ${_report}")
    endif()
