...
if("TRUE" STREQUAL "TRUE")
  set(freespace_planner_SOURCE_PREFIX /home/dink/DINK/ros/src/computing/planning/mission/packages/freespace_planner)
  set(freespace_planner_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(freespace_planner_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Tomohito ANDO <antm678@ertl.jp>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'freespace_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/computing/planning/mission/packages/freespace_planner/${idir}'.  ${_report}")
    endif()
