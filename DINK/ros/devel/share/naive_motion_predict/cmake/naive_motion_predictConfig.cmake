...
if("TRUE" STREQUAL "TRUE")
  set(naive_motion_predict_SOURCE_PREFIX /home/dink/DINK/ros/src/computing/perception/prediction/motion_predictor/packages/naive_motion_predict)
  set(naive_motion_predict_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(naive_motion_predict_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naive_motion_predict' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/computing/perception/prediction/motion_predictor/packages/naive_motion_predict/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;sensor_msgs;dink_for_msgs;tf;imm_ukf_pda_track")
