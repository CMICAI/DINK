...
if("TRUE" STREQUAL "TRUE")
  set(oculus_socket_SOURCE_PREFIX /home/dink/DINK/ros/src/socket/packages/oculus_socket)
  set(oculus_socket_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(oculus_socket_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'ni519 <ni519@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'oculus_socket' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/socket/packages/oculus_socket/${idir}'.  ${_report}")
    endif()
