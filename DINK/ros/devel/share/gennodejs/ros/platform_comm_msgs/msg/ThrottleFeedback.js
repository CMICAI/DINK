...
class ThrottleFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ThrottleFeedback(null);
  ...
  static datatype() {
    ...
    return 'platform_comm_msgs/ThrottleFeedback';
  }
  ...
  static messageDefinition() {
    ...
    return `
    # Current Throttle Pedal Position Feedback
  ...
  static Resolve(msg) {
    ...
    const resolved = new ThrottleFeedback(null);
...
module.exports = ThrottleFeedback;
