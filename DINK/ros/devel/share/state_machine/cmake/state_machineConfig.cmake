...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/dink/DINK/ros/src/computing/planning/state/state_machine)
  set(state_machine_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/computing/planning/state/state_machine/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;geometry_msgs;dink_for_msgs")
