...
if("TRUE" STREQUAL "TRUE")
  set(points_downsampler_SOURCE_PREFIX /home/dink/DINK/ros/src/sensing/filters/packages/points_downsampler)
  set(points_downsampler_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(points_downsampler_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT "/home/dink/DINK/ros/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'points_downsampler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/sensing/filters/packages/points_downsampler/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;pcl_ros;sensor_msgs;pcl_conversions;velodyne_pointcloud;message_generation;dink_for_config_msgs")
