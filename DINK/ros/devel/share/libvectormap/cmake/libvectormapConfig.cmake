...
if("TRUE" STREQUAL "TRUE")
  set(libvectormap_SOURCE_PREFIX /home/dink/DINK/ros/src/common/libvectormap)
  set(libvectormap_DEVEL_PREFIX /home/dink/DINK/ros/devel)
  ...
  set(libvectormap_INSTALL_PREFIX /home/dink/DINK/ros/install)
...
if(NOT "/home/dink/DINK/ros/src/common/libvectormap/include;/usr/include/eigen3 " STREQUAL " ")
  set(libvectormap_INCLUDE_DIRS "")
  set(_include_dirs "/home/dink/DINK/ros/src/common/libvectormap/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libvectormap' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dink/DINK/ros/src/common/libvectormap/${idir}'.  ${_report}")
    endif()
