// Generated by gencpp from file perception_msgs/ObjectArray.msg
// DO NOT EDIT!


#ifndef PERCEPTION_MSGS_MESSAGE_OBJECTARRAY_H
#define PERCEPTION_MSGS_MESSAGE_OBJECTARRAY_H
...
struct ObjectArray_
{
  ...
  typedef boost::shared_ptr< ::perception_msgs::ObjectArray_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::perception_msgs::ObjectArray_<ContainerAllocator> const> ConstPtr;

}; // struct ObjectArray_

typedef ::perception_msgs::ObjectArray_<std::allocator<void> > ObjectArray;

typedef boost::shared_ptr< ::perception_msgs::ObjectArray > ObjectArrayPtr;
typedef boost::shared_ptr< ::perception_msgs::ObjectArray const> ObjectArrayConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::perception_msgs::ObjectArray_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::perception_msgs::ObjectArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::perception_msgs::ObjectArray_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::perception_msgs::ObjectArray_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::perception_msgs::ObjectArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::perception_msgs::ObjectArray_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::perception_msgs::ObjectArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::perception_msgs::ObjectArray_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::perception_msgs::ObjectArray_<ContainerAllocator> >
{
  ...
  static const char* value(const ::perception_msgs::ObjectArray_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x492c83cd255b9a57ULL;
  static const uint64_t static_value2 = 0x845d0c197d7977beULL;
};

template<class ContainerAllocator>
struct DataType< ::perception_msgs::ObjectArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::perception_msgs::ObjectArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::perception_msgs::ObjectArray_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::perception_msgs::ObjectArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::perception_msgs::ObjectArray_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // PERCEPTION_MSGS_MESSAGE_OBJECTARRAY_H
