...
// *********************************************************
//
// File autogenerated for the rslidar_pointcloud package
// by the dynamic_reconfigure package.
// Please do not edit.
//
// ********************************************************/

#ifndef __rslidar_pointcloud__CLOUDNODECONFIG_H__
#define __rslidar_pointcloud__CLOUDNODECONFIG_H__
...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CloudNodeConfig::AbstractParamDescriptionConstPtr(new CloudNodeConfig::ParamDescription<double>("time_offset", "double", 0, "A manually calibrated offset (in seconds) to add to the timestamp before publication of a message.", "", &CloudNodeConfig::time_offset)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CloudNodeConfig::AbstractParamDescriptionConstPtr(new CloudNodeConfig::ParamDescription<double>("time_offset", "double", 0, "A manually calibrated offset (in seconds) to add to the timestamp before publication of a message.", "", &CloudNodeConfig::time_offset)));
