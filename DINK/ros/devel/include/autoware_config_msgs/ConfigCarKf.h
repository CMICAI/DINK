// Generated by gencpp from file dink_for_config_msgs/ConfigCarKf.msg
// DO NOT EDIT!


#ifndef dink_for_CONFIG_MSGS_MESSAGE_CONFIGCARKF_H
#define dink_for_CONFIG_MSGS_MESSAGE_CONFIGCARKF_H
...
struct ConfigCarKf_
{
  ...
  typedef boost::shared_ptr< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigCarKf_

typedef ::dink_for_config_msgs::ConfigCarKf_<std::allocator<void> > ConfigCarKf;

typedef boost::shared_ptr< ::dink_for_config_msgs::ConfigCarKf > ConfigCarKfPtr;
typedef boost::shared_ptr< ::dink_for_config_msgs::ConfigCarKf const> ConfigCarKfConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x35fb5980cbba7f23ULL;
  static const uint64_t static_value2 = 0x7457ede929c58aa9ULL;
};

template<class ContainerAllocator>
struct DataType< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dink_for_config_msgs::ConfigCarKf_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // dink_for_CONFIG_MSGS_MESSAGE_CONFIGCARKF_H
